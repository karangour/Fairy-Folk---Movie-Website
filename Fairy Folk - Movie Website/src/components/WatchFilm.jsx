...
export default function WatchFilm() {
    return (
        ...
        <hr className="underline-heading-fairyfolk" />
            ...
            <p className='cast-instruct'>You can press the &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; icon to watch the film on your TV screen. Just make sure your TV and your phone/iPad/laptop are connected to the same WiFi network.</p>
